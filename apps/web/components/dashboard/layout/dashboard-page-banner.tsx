    ...
    <section className="mb-5 border-b border-slate-200/80 pb-4 pt-1 text-slate-950">
      <div className="min-w-0">
        <div className="mb-2 flex flex-wrap items-center gap-2">
          <span className="inline-flex h-6 items-center rounded-md border border-emerald-200 bg-emerald-50 px-2 text-[0.7rem] font-semibold uppercase tracking-[0.14em] text-emerald-800">
            {copy.eyebrow}
          </span>
