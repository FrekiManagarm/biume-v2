    ...
    <EmailLayout preview="Reset your Biume password">
      <Container className="mx-auto">
        ...
        <Text className="text-gray-600 mb-4">
          We received a request to reset your Biume account password. Click the button below to choose a new password:
        </Text>

        <Section className="text-center my-8">
          <Button className="bg-indigo-600 text-white px-6 py-3 rounded-md font-medium" href={resetLink}>
            Reset Password
          </Button>
        </Section>
        ...
        <Text className="text-gray-600 mb-4">For security reasons, this link will expire in 24 hours.</Text>
