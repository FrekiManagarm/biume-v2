  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[90rem] lg:relative lg:min-h-[44rem] lg:overflow-hidden">
        <div className="atelier-reveal atelier-reveal-delay-1 relative z-20 max-w-[46rem] pt-8 lg:w-[48%] lg:pt-20">
        ...
        <div className="atelier-reveal atelier-reveal-delay-2 relative mt-10 h-[25rem] overflow-hidden rounded-[var(--atelier-media-radius)] sm:h-[32rem] lg:absolute lg:inset-y-0 lg:right-0 lg:mt-0 lg:h-auto lg:w-[48%]">
          <Image
        ...
        <div
          ...
          className="atelier-reveal atelier-reveal-delay-3 relative z-30 mt-6 w-full rounded-[var(--atelier-surface-radius)] bg-[color:var(--atelier-surface)] shadow-[0_6px_8px_rgba(107,90,200,0.16)] sm:w-[min(34rem,100%)] lg:w-[48%] xl:absolute xl:bottom-10 xl:left-[40%] xl:mt-0 xl:w-[min(34rem,88%)]"
        >
          <div className="flex items-center justify-between border-b border-[color:var(--atelier-line)] px-5 py-4">
            <h2 className="text-sm font-semibold">Préparation propriétaire</h2>
          ...
          <div className="grid gap-3 p-4 sm:grid-cols-[1fr_auto_1fr] sm:items-center sm:p-5">
            <div className="rounded-[var(--atelier-surface-radius)] bg-[color:var(--atelier-muted-surface)] p-4">
              <h3 className="text-xs font-semibold">Notes professionnelles</h3>
            ...
            <div className="rounded-[var(--atelier-surface-radius)] bg-[color:var(--atelier-violet-soft)] p-4">
              <h3 className="text-xs font-semibold">Version propriétaire</h3>
