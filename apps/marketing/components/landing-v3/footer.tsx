...
export function Footer() {
  return (
    <footer className="bg-[color:var(--lv3-canvas)]">
      <div className="mx-auto max-w-[1280px] px-5 py-16 md:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-[1.1fr_1fr_1fr_0.7fr]">
          <div>
            <Link
              href="/"
              className="flex min-h-11 items-center gap-2 text-[1.2rem] font-bold tracking-[-0.03em] text-[color:var(--lv3-ink)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[color:var(--lv3-violet)]"
            >
              <Image
            ...
            <p className="mt-4 max-w-[32ch] text-[0.9rem] leading-[1.6] text-[color:var(--lv3-ink-2)]">
          ...
          {COLUMNS.map((column) => (
            <nav key={column.title} aria-label={`Pied de page — ${column.title}`}>
              ...
              <p className="lv3-fn text-[color:var(--lv3-ink)]">
                  ...
                  <li key={link.href}>
                    {link.href.startsWith("http") ? (
                      <a
                        ...
                        className="lv3-link text-[0.9rem]"
                      >
                        {link.label}
                      </a>
                    ) : (
                      <Link href={link.href} className="lv3-link text-[0.9rem]">
                        {link.label}
                      </Link>
                    )}
                  </li>
        ...
        <p className="mt-14 border-t border-[color:var(--lv3-line)] pt-7 text-[0.82rem] text-[color:var(--lv3-ink-2)]">
